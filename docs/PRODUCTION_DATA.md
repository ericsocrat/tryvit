...
**Location:** `supabase/migrations/` — **237 migration files**, append-only.
...
```
supabase db reset
  → Applies all 237 migrations in order (supabase/migrations/*.sql)
...
1. 237 migration files (schema + functions + views)
