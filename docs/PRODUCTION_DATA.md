...
**Location:** `supabase/migrations/` — **236 migration files**, append-only.
...
```
supabase db reset
  → Applies all 236 migrations in order (supabase/migrations/*.sql)
...
1. 236 migration files (schema + functions + views)
