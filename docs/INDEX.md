...
> **Tracked inventory:** 72 top-level Markdown documents and 1 API registry in `docs/`; 11 ADR files in `docs/decisions/`; 3 generated/historical artifacts in `docs/phase5/`; 25 logo assets; 7 banner assets; and 7 Markdown documents at the repository root
...
| [Frontend & UX](#frontend--ux)                           | 19    | UX/UI design, UX impact metrics, brand guidelines, name candidates, design system, frontend README, design refresh spec, product positioning, Phase 5 audit/blueprint/roadmap, visual-test safety, route/PWA policy, provider/locale/rendering contract, performance/visual gates, private PWA cache safety, Design System V2 foundations, Experience Architecture and Golden Reference gate |
...
| [PHASE5_IMPLEMENTATION_ROADMAP.md](PHASE5_IMPLEMENTATION_ROADMAP.md)                       | Staged Phase 5 plan: exactly two 5A.1 PRs, non-production 5A.2 approval gate, then production migration                | Frontend domain                                         | 2026-08-10   |
...
| [PHASE5A1_DESIGN_SYSTEM_FOUNDATIONS.md](PHASE5A1_DESIGN_SYSTEM_FOUNDATIONS.md)             | Direction-resilient V2 foundations, V1 parity, accessibility contracts, inventory and catalog candidates               | Phase 5A.1a                                             | 2026-08-10   |
| [PHASE5A2_EXPERIENCE_ARCHITECTURE_GOLDEN_REFERENCE.md](PHASE5A2_EXPERIENCE_ARCHITECTURE_GOLDEN_REFERENCE.md) | Planned non-production art-direction, identity, content, motion and six-experience Golden Reference approval contract | Phase 5A.2                                              | 2026-08-10   |
