...
> **Tracked inventory:** 72 top-level Markdown documents and 1 API registry in `docs/`; 11 ADR files in `docs/decisions/`; 7 generated/supporting artifacts in `docs/phase5/`; 10 Checkpoint 1 handoff documents and 35 generated evidence files in `docs/phase5a2/`; 25 logo assets; 7 banner assets; and 7 Markdown documents at the repository root
...
| [Frontend & UX](#frontend--ux)                           | 32    | UX/UI design, UX impact metrics, brand guidelines, name candidates, design system, frontend README, design refresh spec, product positioning, Phase 5 audit/blueprint/roadmap, visual-test safety, route/PWA policy, provider/locale/rendering contract, performance/visual gates, private PWA cache safety, Design System V2 foundations, Experience Architecture gate, and Checkpoint 1 research/handoff |
...
| [PHASE5A2_EXPERIENCE_ARCHITECTURE_GOLDEN_REFERENCE.md](PHASE5A2_EXPERIENCE_ARCHITECTURE_GOLDEN_REFERENCE.md) | Active non-production art-direction, identity, content, motion and six-experience Golden Reference approval contract | Phase 5A.2                                              | 2026-08-17   |
