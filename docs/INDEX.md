...
| [Frontend & UX](#frontend--ux)                           | 36    | UX/UI design, UX impact metrics, brand guidelines, name candidates, design system, frontend README, design refresh spec, product positioning, Phase 5 audit/blueprint/roadmap, visual-test safety, route/PWA policy, provider/locale/rendering contract, performance/visual gates, private PWA cache safety, Design System V2 foundations, completed Experience Architecture gate, Checkpoint 1/2 handoffs, landing-governance prerequisite, and Phase 5A.3 landing draft evidence |
