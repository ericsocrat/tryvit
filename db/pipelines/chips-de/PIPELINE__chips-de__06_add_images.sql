...
FROM (
  VALUES
    ...
    ('Lay''s', 'Aus dem Ofen Mediterrane Kräuter', 'https://images.openfoodfacts.org/images/products/406/213/900/5550/front_en.35.400.jpg', 'off_api', 'front', true, 'Front — EAN 4062139005550', 'front_4062139005550'),
    ('Gut Bio', 'Bio-Gemüsechips mit Meersalz', 'https://images.openfoodfacts.org/images/products/404/724/700/4657/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4047247004657', 'front_4047247004657'),
    ('Gut Bio', 'Bio-Süßkartoffelchips mit Meersalz', 'https://images.openfoodfacts.org/images/products/404/724/700/4664/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4047247004664', 'front_4047247004664'),
    ('Bio-Zentrale', 'Gemüsechips – Pastinake, Chioggia Beete, lila Süßkartoffel, Kartoffel, schwarzer Pfeffer & Meersalz', 'https://images.openfoodfacts.org/images/products/400/500/910/3345/front_de.36.400.jpg', 'off_api', 'front', true, 'Front — EAN 4005009103345', 'front_4005009103345'),
    ...
    ('Biozentrale', 'Biozentrale Gemüsechips Süsskartoffel Rosmarin 4005009103352 Süßkartofelchips', 'https://images.openfoodfacts.org/images/products/400/500/910/3352/front_de.38.400.jpg', 'off_api', 'front', true, 'Front — EAN 4005009103352', 'front_4005009103352'),
    ('Bio Zentrale', 'Tortilla Röllchen', 'https://images.openfoodfacts.org/images/products/400/500/910/4625/front_de.27.400.jpg', 'off_api', 'front', true, 'Front — EAN 4005009104625', 'front_4005009104625'),
    ('XOX Snack', 'Knuffels Schinken & Käse', 'https://images.openfoodfacts.org/images/products/403/144/640/2611/front_en.14.400.jpg', 'off_api', 'front', true, 'Front — EAN 4031446402611', 'front_4031446402611'),
    ('Lorenz', 'Erdnuß Locken Balls Classic', 'https://images.openfoodfacts.org/images/products/401/807/701/0170/front_en.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4018077010170', 'front_4018077010170'),
    ('Funny Frisch', 'Pom-Bär', 'https://images.openfoodfacts.org/images/products/400/052/210/5241/front_de.21.400.jpg', 'off_api', 'front', true, 'Front — EAN 4000522105241', 'front_4000522105241'),
    ...
    ('Funny-frisch', 'Kesselchips Sweet Chili', 'https://images.openfoodfacts.org/images/products/400/358/600/2914/front_de.30.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586002914', 'front_4003586002914'),
    ...
    ('Lorenz', 'Naturals - Milde Paprika', 'https://images.openfoodfacts.org/images/products/401/807/771/4399/front_de.28.400.jpg', 'off_api', 'front', true, 'Front — EAN 4018077714399', 'front_4018077714399'),
    ('Aldi', 'Stapelchips - Sour Cream & Onion-Geschmack', 'https://images.openfoodfacts.org/images/products/406/145/806/1575/front_en.24.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061458061575', 'front_4061458061575'),
    ('Lorenz', 'Crunchips WoW Paprika and Sour Cream', 'https://images.openfoodfacts.org/images/products/401/807/782/2018/front_fr.37.400.jpg', 'off_api', 'front', true, 'Front — EAN 4018077822018', 'front_4018077822018'),
    ('Lorenz', 'Crunchips Burrito Style', 'https://images.openfoodfacts.org/images/products/401/807/700/9266/front_de.22.400.jpg', 'off_api', 'front', true, 'Front — EAN 4018077009266', 'front_4018077009266'),
    ('Snack Day', 'Tortilla Chips Gesalzen', 'https://images.openfoodfacts.org/images/products/405/648/946/2866/front_de.34.400.jpg', 'off_api', 'front', true, 'Front — EAN 4056489462866', 'front_4056489462866'),
    ('XOX', 'Krupuk', 'https://images.openfoodfacts.org/images/products/403/144/682/0453/front_de.18.400.jpg', 'off_api', 'front', true, 'Front — EAN 4031446820453', 'front_4031446820453'),
    ('Asia Green Garden', 'Krabbenchips - Chili', 'https://images.openfoodfacts.org/images/products/406/145/810/4029/front_de.13.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061458104029', 'front_4061458104029'),
    ('Bio-Zentrale', 'Rote Beete Chips – Meersalz', 'https://images.openfoodfacts.org/images/products/400/500/910/3383/front_de.20.400.jpg', 'off_api', 'front', true, 'Front — EAN 4005009103383', 'front_4005009103383'),
    ('Aldi Sports', 'Protein-Chips - Sour Cream & Onion-Geschmack', 'https://images.openfoodfacts.org/images/products/406/146/291/2238/front_de.6.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061462912238', 'front_4061462912238'),
    ('Sun Snacks', 'Kessel-Chips - Salt & Vinegar-Geschmack', 'https://images.openfoodfacts.org/images/products/406/145/805/9008/front_de.55.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061458059008', 'front_4061458059008'),
    ('Funny-frisch', 'Popchips Sea Salt & Black Pepper', 'https://images.openfoodfacts.org/images/products/400/358/610/5134/front_de.10.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586105134', 'front_4003586105134'),
    ('Henderson and Sons', 'Tortilla Chips', 'https://images.openfoodfacts.org/images/products/405/309/108/2048/front_de.11.400.jpg', 'off_api', 'front', true, 'Front — EAN 4053091082048', 'front_4053091082048'),
    ('Henderson and Sons', 'Tortilla Chips Hot Chili Taste', 'https://images.openfoodfacts.org/images/products/405/309/108/2352/front_en.13.400.jpg', 'off_api', 'front', true, 'Front — EAN 4053091082352', 'front_4053091082352'),
    ('Lorenz', 'Crunchips African Style', 'https://images.openfoodfacts.org/images/products/401/807/700/4568/front_fr.31.400.jpg', 'off_api', 'front', true, 'Front — EAN 4018077004568', 'front_4018077004568'),
    ('K-Classic', 'Sonne,mond & sterne snack', 'https://images.openfoodfacts.org/images/products/406/336/719/4788/front_de.16.400.jpg', 'off_api', 'front', true, 'Front — EAN 4063367194788', 'front_4063367194788'),
    ('Halloween', 'Gespenster - Original', 'https://images.openfoodfacts.org/images/products/406/145/803/6269/front_de.35.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061458036269', 'front_4061458036269'),
    ('Aldi', 'Farmer-Kartoffelchips - Chili Style', 'https://images.openfoodfacts.org/images/products/406/146/192/2719/front_de.8.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061461922719', 'front_4061461922719'),
    ('Aldi Sports', 'Protein-Chips - Paprikageschmack', 'https://images.openfoodfacts.org/images/products/406/146/291/2191/front_de.25.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061462912191', 'front_4061462912191'),
    ('Funny frisch', 'Intense Perky Pepper Chips', 'https://images.openfoodfacts.org/images/products/400/358/610/5677/front_de.4.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586105677', 'front_4003586105677'),
    ('Funny-frisch', 'Chipsfrisch ungarisch', 'https://images.openfoodfacts.org/images/products/400/358/610/0313/front_de.63.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586100313', 'front_4003586100313'),
    ...
    ('Clancy''s', 'Nacho Cheese Flavored Tortilla Chips', 'https://images.openfoodfacts.org/images/products/406/146/483/8192/front_en.5.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061464838192', 'front_4061464838192'),
    ...
    ('Doritos', 'Maischips - Whopper-Geschmack', 'https://images.openfoodfacts.org/images/products/406/213/902/6760/front_en.25.400.jpg', 'off_api', 'front', true, 'Front — EAN 4062139026760', 'front_4062139026760'),
    ...
    ('Crunchips', 'Crunchips Paprika', 'https://images.openfoodfacts.org/images/products/401/807/700/6104/front_en.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4018077006104', 'front_4018077006104'),
    ('Lay''s', 'Bugles Nacho Cheese', 'https://images.openfoodfacts.org/images/products/406/213/900/9879/front_de.7.400.jpg', 'off_api', 'front', true, 'Front — EAN 4062139009879', 'front_4062139009879'),
    ('Funny-frisch', 'Kessel Chips Cross Cut - Spicy BBQ', 'https://images.openfoodfacts.org/images/products/400/358/610/0795/front_en.21.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586100795', 'front_4003586100795'),
    ('DmBio', 'Kichererbsen Chips', 'https://images.openfoodfacts.org/images/products/406/779/612/5450/front_en.21.400.jpg', 'off_api', 'front', true, 'Front — EAN 4067796125450', 'front_4067796125450'),
    ('Heimatgut', 'Bio-Gemüsechips - Fein gesalzen', 'https://images.openfoodfacts.org/images/products/426/035/092/6566/front_de.9.400.jpg', 'off_api', 'front', true, 'Front — EAN 4260350926566', 'front_4260350926566'),
    ('Funny-Frisch', 'Popchips', 'https://images.openfoodfacts.org/images/products/400/358/610/5141/front_en.7.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586105141', 'front_4003586105141'),
    ('Funny-frisch', 'Riffels Chili & Paprika', 'https://images.openfoodfacts.org/images/products/400/358/600/0330/front_de.47.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586000330', 'front_4003586000330'),
    ('Chio', 'CHIO Chips', 'https://images.openfoodfacts.org/images/products/400/124/210/8567/front_en.19.400.jpg', 'off_api', 'front', true, 'Front — EAN 4001242108567', 'front_4001242108567'),
    ('Sportness', 'Protein Linsen Chips', 'https://images.openfoodfacts.org/images/products/406/644/724/7138/front_de.24.400.jpg', 'off_api', 'front', true, 'Front — EAN 4066447247138', 'front_4066447247138'),
    ('Sun Snacks', 'Geriffelte Chips - Salz', 'https://images.openfoodfacts.org/images/products/406/146/459/6610/front_de.17.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061464596610', 'front_4061464596610'),
    ('Chio', 'Chio', 'https://images.openfoodfacts.org/images/products/400/124/210/8758/front_de.14.400.jpg', 'off_api', 'front', true, 'Front — EAN 4001242108758', 'front_4001242108758'),
    ('Funny Frisch', 'Ringli', 'https://images.openfoodfacts.org/images/products/400/358/610/2713/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586102713', 'front_4003586102713'),
    ('Funny-frisch', 'Sweet & Roasted onian', 'https://images.openfoodfacts.org/images/products/400/358/610/8937/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586108937', 'front_4003586108937'),
    ('Doritos', 'Doritos BBQ Style', 'https://images.openfoodfacts.org/images/products/406/213/902/6463/front_de.5.400.jpg', 'off_api', 'front', true, 'Front — EAN 4062139026463', 'front_4062139026463'),
    ('Funny-frisch', 'Chipsfrisch', 'https://images.openfoodfacts.org/images/products/400/358/610/7503/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586107503', 'front_4003586107503'),
    ('Funny-Frisch', 'Cornados - Paprika Style', 'https://images.openfoodfacts.org/images/products/400/358/610/5721/front_de.14.400.jpg', 'off_api', 'front', true, 'Front — EAN 4003586105721', 'front_4003586105721'),
    ('Snack Day', 'Tortilla Chips Paprika', 'https://images.openfoodfacts.org/images/products/405/648/946/2897/front_de.17.400.jpg', 'off_api', 'front', true, 'Front — EAN 4056489462897', 'front_4056489462897'),
    ('Sun Snacks', 'Dolphy''s Paprikageschmack', 'https://images.openfoodfacts.org/images/products/406/146/225/5328/front_de.15.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061462255328', 'front_4061462255328'),
    ('K-Classic', 'Stapelchips Sourcream & Onion', 'https://images.openfoodfacts.org/images/products/406/336/742/4526/front_de.11.400.jpg', 'off_api', 'front', true, 'Front — EAN 4063367424526', 'front_4063367424526'),
    ('Chio', 'Hot peperoni chips', 'https://images.openfoodfacts.org/images/products/400/124/210/8543/front_de.19.400.jpg', 'off_api', 'front', true, 'Front — EAN 4001242108543', 'front_4001242108543'),
    ('Intersnack', 'Ofen-Minis - Paprika', 'https://images.openfoodfacts.org/images/products/400/052/213/7075/front_de.22.400.jpg', 'off_api', 'front', true, 'Front — EAN 4000522137075', 'front_4000522137075'),
    ('Intersnack Deutschland SE', 'Tortillas', 'https://images.openfoodfacts.org/images/products/400/124/210/5962/front_en.9.400.jpg', 'off_api', 'front', true, 'Front — EAN 4001242105962', 'front_4001242105962'),
    ('Sun Snacks', 'Geriffelte Chips - Chili-Paprika', 'https://images.openfoodfacts.org/images/products/406/146/459/6641/front_de.15.400.jpg', 'off_api', 'front', true, 'Front — EAN 4061464596641', 'front_4061464596641'),
    ('K-Classic', 'Stapel Chips Paprika Style', 'https://images.openfoodfacts.org/images/products/406/336/742/4533/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4063367424533', 'front_4063367424533'),
    ('Snack Day', 'Tortilla Chips Nacho Cheese', 'https://images.openfoodfacts.org/images/products/405/648/946/2903/front_de.3.400.jpg', 'off_api', 'front', true, 'Front — EAN 4056489462903', 'front_4056489462903')
