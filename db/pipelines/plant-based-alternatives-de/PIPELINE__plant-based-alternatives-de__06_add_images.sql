...
FROM (
  VALUES
    ...
    ('Barilla', 'Spaghetti n5', 'https://images.openfoodfacts.org/images/products/807/680/019/5057/front_en.3704.400.jpg', 'off_api', 'front', true, 'Front — EAN 8076800195057', 'front_8076800195057')
