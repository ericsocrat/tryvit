export function AuthCurrentLogo({ className }: Readonly<{ className?: string }>) {
  return (
    <span className={className} data-auth-current-lockup="horizontal">
      ...
      <svg aria-label="TryVit" role="img" viewBox="0 0 96 28" width={96} height={28}>
        <path
