 ...
 *
 * Shows stored catalogue associations alphabetically, without implied
 * nutritional ranking, verified substitution or matching confidence.
 */
  ...
  return (
    <div className="mt-1 ml-6">
      ...
      {expanded && (
        ...
        >
          <li className="text-xs text-foreground-secondary">{t("evidenceActivity.ingredientLinks")}</li>
          {[...products].sort((a, b) => a.product_name.localeCompare(b.product_name) || a.product_id - b.product_id).map((product) => (
