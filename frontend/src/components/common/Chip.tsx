...
const VARIANT_CLASSES: Record<ChipVariant, string> = {
  default: "bg-surface-muted/95 text-foreground-secondary border-transparent",
  ...
  return (
    <Tag
      ...
      className={[
        ...
        interactive
          ? "cursor-pointer hover:brightness-95 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand/30"
          : "",
        className,
      ]
        .filter(Boolean)
    ...
    >
      ...
      {onRemove && (
        <button
          ...
          className="ml-0.5 inline-flex h-4 w-4 items-center justify-center rounded-full transition-colors motion-reduce:transition-none hover:bg-chip-remove-hover focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand/30"
        >
