    ...
    <div className={className}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={[
            "block w-full rounded-xl border bg-surface/95 shadow-[0_8px_20px_rgba(15,23,42,0.06)] transition-[border-color,box-shadow,background-color,color] motion-reduce:transition-none",
