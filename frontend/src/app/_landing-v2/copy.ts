...
export const LANDING_COPY: Readonly<Record<SupportedLanguage, LandingCopy>> = Object.freeze({
  en: {
    ...
    derivedDetail: "Compare these values only with the same units and preparation basis",
    derivedMeta: "No overall product grade",
    contextDetail: "Compared on an oat-drink basis; processing is not assessed",
    contextMeta: "Processing unknown · no confidence rating",
    ...
    methodBody:
      "Compare compatible recorded facts and inspect their sources and missing information. A single product does not receive an overall health grade or a confidence rating.",
  ...
  pl: {
    ...
    derivedDetail: "Porównuj te wartości tylko przy zgodnych jednostkach i sposobie przygotowania",
    derivedMeta: "Bez ogólnej oceny produktu",
    contextDetail: "Porównanie napojów owsianych; przetworzenia nie oceniono",
    contextMeta: "Przetworzenie nieznane · bez oceny wiarygodności",
    ...
    methodBody:
      "Porównuj zgodne zapisane dane oraz sprawdzaj ich źródła i braki. Produkt nie otrzymuje ogólnej oceny zdrowotnej ani oceny wiarygodności.",
  ...
  de: {
    ...
    derivedDetail: "Diese Werte nur bei gleichen Einheiten und gleichem Zubereitungszustand vergleichen",
    derivedMeta: "Keine Gesamtnote für das Produkt",
    contextDetail: "Verglichen auf Haferdrink-Basis; Verarbeitungsgrad nicht bewertet",
    contextMeta: "Verarbeitung unbekannt · keine Verlässlichkeitsnote",
    ...
    methodBody:
      "Vergleiche kompatible erfasste Angaben und prüfe ihre Quellen und Lücken. Ein Produkt erhält weder eine allgemeine Gesundheitsnote noch eine Verlässlichkeitsnote.",
