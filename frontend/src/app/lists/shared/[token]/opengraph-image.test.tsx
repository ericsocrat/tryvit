// ─── Unit tests for list OG image helper functions ──────────────────────────
...
describe("list opengraph-image helpers", () => {
  ...
  describe("truncate", () => {
    ...
    it("truncates with ellipsis when text exceeds max", () => {
      const result = truncate("A very long product name", 15);
  ...
  describe("module exports", () => {
    ...
    it("exports alt text for list", async () => {
      const mod = await import("./opengraph-image");
      expect(mod.alt).toContain("list");
    });
